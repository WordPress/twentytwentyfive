	...
	<div class="wp-block-group alignwide" style="min-height:100vh">
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:66.66%">
				...
				<h2 class="wp-block-heading alignwide has-text-align-left" style="font-size:12vw;font-style:normal;font-weight:300;line-height:0.9"><?php esc_html_e( 'Stories, historias, iсторії, iστορίες.', 'twentytwentyfive' ); ?></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
