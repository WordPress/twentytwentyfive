...
<h2 class="wp-block-heading"><?php esc_html_e( 'Events', 'twentytwentyfive' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/image-from-rawpixel-id-8802835-jpeg-scaled.webp' ); ?>" alt="<?php esc_html_x( 'Event image', 'twentytwentyfive' ); ?>" );/></figure>
<!-- /wp:image -->
