...
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"twentytwentyfive/footer-centered","name":"Footer"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
