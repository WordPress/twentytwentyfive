...
<div class="wp-block-columns" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:column {"width":"40%"} -->
    ...
    <div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:60%"><!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large"} -->
        ...
        <!-- wp:search {"label":"","placeholder":"<?php echo esc_attr_x('Type something...', ''); ?>","buttonText":"<?php echo esc_attr_x('Search', 'twentytwentyfive'); ?>","style":{"border":{"radius":"50px","width":"1px"},"typography":{"fontSize":"18px"}},"borderColor":"opacity-20"} /-->
    </div>
    <!-- /wp:column -->
</div>
<!-- /wp:columns -->
