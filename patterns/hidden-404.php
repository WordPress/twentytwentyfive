	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-bottom">
			...
			<div class="wp-block-group">
				...
				<!-- /wp:paragraph -->
				<!-- wp:search {"label":"<?php esc_html_e( "Search" ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Type something...', 'input placeholder text', 'twentytwentyfive' ); ?>","buttonText":"<?php echo esc_attr_x( 'Search', 'button label', 'twentytwentyfive' ); ?>","style":{"border":{"radius":"999px"}}} /-->
			</div>
			<!-- /wp:group -->
		</div>
		<!-- /wp:column -->
