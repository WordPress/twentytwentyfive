...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-group">
							...
							<p class="has-small-font-size"><?php esc_html__( 'Published on', 'twentytwentyfive' ); ?></p>
							<!-- /wp:paragraph -->
						...
						<div class="wp-block-group">
							<!-- wp:paragraph {"fontSize":"small"} -->
							<p class="has-small-font-size"><?php esc_html__( 'Posted by', 'twentytwentyfive' ); ?></p>
							<!-- /wp:paragraph -->
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-group">
							<!-- wp:paragraph {"fontSize":"small"} -->
							<p class="has-small-font-size"><?php esc_html__( 'Categories', 'twentytwentyfive' ); ?>:</p>
							<!-- /wp:paragraph -->
						...
						<div class="wp-block-group">
							<!-- wp:paragraph {"fontSize":"small"} -->
							<p class="has-small-font-size"><?php esc_html__( 'Tagged', 'twentytwentyfive' ); ?>:</p>
							<!-- /wp:paragraph -->
		...
		<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:0">
			...
			<nav aria-label="Posts navigation" class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
